...
export function middleware() {
  const cspHeader = `
    ...
    script-src 'self' 'unsafe-inline' 'unsafe-eval' https://*.flowise.theanswer.ai https://*.theanswer.ai https://*.sentry.io https://*.google-analytics.com https://*.googletagmanager.com https://*.googletagmanager.com https://*.google-analytics.com vitals.vercel-insights.com https://*.hs-analytics.net https://*.hs-banner.com https://*.hsadspixel.net https://*.hscollectedforms.net https://*.jquery.com https://*.hs-scripts.com https://*.hsforms.net netlify-cdp-loader.netlify.app;
    ...
    frame-src 'self' lastrev.com forms.hsforms.com https://*.theanswer.ai https://*.flowise.theanswer.ai https://*.googletagmanager.com https://*.googletagmanager.com https://*.google-analytics.com;
    img-src * data: https://*.googletagmanager.com https://*.ctfassets.net https://*.googletagmanager.com https://*.google-analytics.com;
    media-src * data:;
    object-src 'none';
    base-uri 'self';
    form-action 'self';
