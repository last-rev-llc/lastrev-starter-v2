...
export function middleware() {
  const cspHeader = `
    default-src 'self' localhost:8888 *.sentry.io *.facebook.com vitals.vercel-insights.com *.hubapi.com *.hsforms.com *.hs-scripts.com *.hsforms.net *.hscollectedforms.net *.netlify.app;
    ...
    frame-src 'self' lastrev.com forms.hsforms.com;
    img-src * data:;
    media-src * data:;
    object-src 'none';
    base-uri 'self';
