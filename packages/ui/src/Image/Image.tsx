...
const Image = React.forwardRef<any, ImageProps>(function Image(props, ref) {
  ...
  const imgContent = React.useMemo(() => {
    ...
    const generateSources = () => {
      ...
      const imageSize = calculateImageSizeForDiv(
        maxWidth,
        maxHeight,
        originalImageWidth,
        originalImageHeight
      ...
      for (const breakpoint in breakpointsMinMax) {
        ...
        if (breakpointWidth && columns?.hasOwnProperty(breakpoint)) {
          ...
          let divWidth = columnsValue ? breakpointWidth / columnsValue : maxWidth;
          let divHeight = columnsValue ? breakpointWidth / columnsValue : maxHeight;
        ...
        <>
          <svg
            ...
            dangerouslySetInnerHTML={{
              __html: `<title>${alt}</title>${imageProps.svgContent}`
            }}
          />
        </>
      );
