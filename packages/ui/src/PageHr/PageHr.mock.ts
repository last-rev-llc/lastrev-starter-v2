...
import { PageHrVariants, type PageHrProps } from './PageHr.types';
// import { mediaBaseImageMock } from '../Media/Media.mock';
import { BlockVariants } from '../Block/Block.types';

const pagehrDefaultMock: PageHrProps = {
  id: randomId(),
  __typename: 'PageHr',
  variant: PageHrVariants.default,
  header: headerBaseMock(),
  footer: footerBaseMock(),
  hero: heroBaseMock(),
  breadcrumbs: breadcrumbsBaseMock().links,
  title: 'This is the PageHr Title',
  contents: [
...
export const pagehrBaseMock = ({ ...override } = {}) => ({
  ...pagehrDefaultMock,
  ...override
});

export default pagehrBaseMock;
